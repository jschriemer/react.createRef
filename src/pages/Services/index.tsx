...
function Services() {
  ...
  return (
    ...
    >
      ...
      <Grid
        item
        xs={isMobileDevice ? 12 : 3} // Full width on mobile, one-fourth on desktop
        sx={{
      ...
      >
        <Grid container direction="column" alignItems="center">
          ...
          <Typography variant="h4">Season 1</Typography>
          <Typography variant="body1">Description for Season 1.</Typography>
        </Grid>
      </Grid>
      ...
      >
        <Grid container direction="column" alignItems="center">
          ...
          <Typography variant="h4">Season 2</Typography>
          <Typography variant="body1">Description for Season 2.</Typography>
        </Grid>
      </Grid>
      ...
      >
        <Grid container direction="column" alignItems="center">
          ...
          <Typography variant="h4">Season 3</Typography>
          <Typography variant="body1">Description for Season 3.</Typography>
        </Grid>
      </Grid>
      ...
      >
        <Grid container direction="column" alignItems="center">
          ...
          />
          <Typography variant="h4">Season 4</Typography>
          <Typography variant="body1">Description for Season 4.</Typography>
        </Grid>
      </Grid>
    </Grid>
  );
