      ...
      >
        ...
        >
          ...
          <Grid container sx={{ flexDirection: "column" }}>
            ...
            <Typography
              variant={isTabletDevice || isMobileDevice ? "body1" : "h5"}
            ...
            >
              ...
              ensure your property stays clear and safe during the winter
              months. Experience hassle-free winters with Kona Care's
        ...
        >
          ...
          <Grid container sx={{ flexDirection: "column" }}>
            ...
            <Typography
              ...
              sx={{ maxWidth: "500px", mt: 2, zIndex: 1000 }}
            >
              Kona Care provides a comprehensive spring clean-up service,
              offering a range of options such as aeration, power raking, and
              lawn fertilization. We specialize in planting trees, perennials,
              and annuals sourced from local nurseries in Calgary. Explore our
              garden design and planter options for a vibrant outdoor space.
            </Typography>
          </Grid>
        </Grid>
        ...
        >
          ...
          <Grid container sx={{ flexDirection: "column" }}>
            ...
            <Typography
              ...
              sx={{ maxWidth: "500px", mt: 2, zIndex: 1000 }}
            >
              Transform your yard with Kona Care's summer services, including
              lawn care, garden maintenance, and customizable landscaping
              solutions. Our dedicated team ensures your outdoor space reflects
              your vision and preferences, creating an inviting and beautiful
